...
namespace HospitalManagementSystem1
{
    public partial class DeleteReceptionist : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand(@"DELETE FROM ReceptionistTB WHERE UserID IN (SELECT UserID FROM LogINTB WHERE UserName = @userName);DELETE FROM LogINTB WHERE UserName = @userName", con);
